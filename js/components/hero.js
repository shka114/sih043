...
function renderHero() {
  ...
  const journeySteps = [
    ...
    { label: "2. AI Domain Triage", sub: "NLP Auto-Sort", icon: "sparkles", color: "text-[#D97706]", bg: "bg-[#FEF3C7]" },
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div class="flex flex-wrap items-center gap-2">
            ...
            <div class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#EBF3EE] border border-[#C4DCCE] text-[11px] font-semibold text-[#24543D]">
